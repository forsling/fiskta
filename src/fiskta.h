...
// OpKind type: find, findr, skip, take_len, take_to, take_until, label, goto, viewset, viewclear, sleep, print
...
// LocBase type: cursor, BOF, EOF, name, match_start, match_end, line_start, line_end
