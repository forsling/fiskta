...
static inline void print_usage(void)
{
    ...
    printf("\n");
    printf("EXAMPLES:\n");
    printf("  # Extract lines 5-7\n");
    printf("  fiskta --input data.txt skip 5l take 3l\n");
    printf("\n");
    printf("  # Print last 10 lines\n");
    printf("  fiskta -i data.txt skip to EOF take -10l\n");
    printf("\n");
    printf("  # Find and print error line\n");
    printf("  fiskta -i logs.txt find \"ERROR:\" take to line-end\n");
    printf("\n");
    printf("  # Print all email addresses from file\n");
    printf("  fiskta --continue -i emails.txt find:re \"[A-Za-z0-9._%%+-]+@[A-Za-z0-9.-]+\" take to match-end\n");
    printf("\n");
    printf("  # Print all DHCP leases for given interface\n");
    printf("  fiskta -c -i dhclient.leases find eth0 take until '}'\n");
    printf("\n");
    printf("  # Verify PNG file signature\n");
    ...
    printf("                              moves cursor to start of first match\n");
    ...
    printf("  1               Program failure (no clause succeeded)\n");
