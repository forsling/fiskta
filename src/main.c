...
static void print_usage(void)
{
    ...
    printf("                              Extract rectangle from cursor position\n");
    printf("                              right: horiz offset (b=bytes, c=chars; <0 = left)\n");
    printf("                              down: vert offset in lines (<0 = up)\n");
    printf("                              Auto-detects line endings (CRLF/LF) from first line\n");
...
static void print_examples(void)
{
    ...
    printf("\n");
    printf("RECTANGULAR EXTRACTION (BOX):\n");
    printf("  # Extract single byte at cursor\n");
    printf("  fiskta --input file.txt box 0b 0l\n");
    printf("\n");
    printf("  # Extract 3x2 box from cursor (3 bytes wide, 2 lines tall)\n");
    printf("  fiskta --input file.txt box 2b 1l\n");
    printf("\n");
    printf("  # Extract box using character units (5 UTF-8 chars wide, 2 lines tall)\n");
    printf("  fiskta --input file.txt box 5c 2l\n");
    printf("\n");
    printf("  # Extract box going left and up\n");
    printf("  fiskta --input file.txt skip 2l skip 2b box -1b -1l\n");
    printf("\n");
    printf("STREAMING AND MONITORING:\n");
    printf("  # Monitor log file for errors (delta mode - only process new data)\n");
    printf("  fiskta --loop 1000ms --loop-view delta --input service.log find \"ERROR\" take to line-end\n");
    printf("\n");
    ...
    printf("  fiskta --loop 500ms --loop-view rescan --input status.txt find \"READY\"\n");
    printf("\n");
