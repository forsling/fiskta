...
static void print_examples(void)
{
    ...
    printf("  fiskta --input file.txt box 0 0\n");
    printf("\n");
    printf("  # Extract 3x2 box from cursor\n");
    printf("  fiskta --input file.txt box 2 1\n");
    printf("\n");
    printf("  # Extract box going left and up\n");
    printf("  fiskta --input file.txt skip 2l skip 2b box -1 -1\n");
    printf("\n");
    printf("  # Extract large rectangular section\n");
    printf("  fiskta --input table.txt box 10 5\n");
    printf("\n");
