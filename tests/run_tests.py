...
#             expect=dict(stdout="ab", exit=0)),
        ...
        dict(id="atom-001-discard-within-clause",
             ...
             expect=dict(stdout="", exit=10)),  # whole clause fails, nothing emits
        ...
        dict(id="regex-102-plus-quantifier-requires-one",
             ...
             expect=dict(stdout="", exit=10)),  # Should fail - requires at least one occurrence
        ...
        dict(id="view-006-view-find-no-match",
             ...
             expect=dict(stdout="", exit=10)),  # X is at EOF-1b, excluded from view

        # View with regex operations
        dict(id="view-007-view-find:re-anchors",
             tokens=["viewset","BOF+3b","EOF","find:re","^HEADER","take","to","match-end"], input_file="-", stdin=b"ZZ\nHEADER\n",
             expect=dict(stdout="HEADER", exit=0)),

        dict(id="view-008-view-find:re-no-match",
             tokens=["viewset","BOF","EOF-1b","find:re","^HEADER","take","+6b"], input_file="-", stdin=b"ZZ\nHEADER\n",
        ...
        dict(id="view-021-view-atomic-success",
             tokens=["viewset","BOF+2b","EOF-2b","take","+2b","THEN","take","+2b"], input_file="overlap.txt",
             expect=dict(stdout="cdef", exit=0)),

        dict(id="view-022-view-atomic-failure",
             tokens=["viewset","BOF+2b","EOF-2b","take","+2b","find","XYZ","THEN","take","+2b"], input_file="overlap.txt",
        ...
        dict(id="view-027-view-multi-clause",
             tokens=["viewset","BOF+2b","EOF-2b","take","+2b","THEN","viewclear","take","+2b"], input_file="overlap.txt",
        ...
        dict(id="view-029-view-regex-eol",
             tokens=["viewset","BOF","EOF-3b","find:re","ZZ$","take","to","match-end"], input_file="-", stdin=b"ZZ\nHEADER\n",
        ...
        dict(id="view-041-view-nested-sections",
             ...
             expect=dict(stdout="", exit=10)),  # BEGIN_SECTION_A not found in view [10, EOF-10b)
        ...
        dict(id="view-045-view-regex-complex",
             tokens=["viewset","BOF+2b","EOF-2b","find:re","\\w+","take","+3b"], input_file="overlap.txt",
             expect=dict(stdout="cde", exit=0)),
        ...
        dict(id="stage-002-failed-clause-no-output",
             ...
             expect=dict(stdout="", exit=10)),  # Failed clause should not emit staged output
